...
Seq2Seq = AttentionSeq2Seq(n_steps_in, n_steps_out, n_features, n_features, n_features)
train, infenc, infdec = Seq2Seq.define_models()
train.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['acc'])
# train model
history = train.fit([X1, X2], y, epochs=20, batch_size=25)
...
# 结果绘图
History_plot().loss_plot(history)
